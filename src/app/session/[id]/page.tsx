...
function SessionView() {
  ...
  return (
    <div className="h-full bg-gray-900 text-white flex flex-col">
      {/* Session Header Bar */}
      <div className="relative z-[var(--z-session-header)] flex items-center gap-2 px-3 py-2 bg-gray-800 border-b border-gray-700">
        <Link
          href="/"
      ...
      <div className="relative z-[var(--z-session-info-bar)] bg-gray-800/80 backdrop-blur border-b border-gray-700/50 px-3 sm:px-4 py-2 sm:py-3">
      ...
      <div className="relative z-[var(--z-session-tab-bar)] bg-gray-800/50 border-b border-gray-700/50 px-2 sm:px-4">
        <div className="flex">
          <button
