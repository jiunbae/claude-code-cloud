...
const categoryIcons: Record<SkillCategory, string> = {
  git: 'M13.007 0C5.815 0 0 5.815 0 13c0 5.744 3.724 10.617 8.895 12.343.65.12.89-.282.89-.625v-2.188c-3.62.787-4.383-1.745-4.383-1.745-.591-1.504-1.445-1.903-1.445-1.903-1.183-.808.088-.792.088-.792 1.308.092 1.995 1.342 1.995 1.342 1.164 1.993 3.052 1.418 3.796 1.085.118-.844.455-1.418.828-1.744-2.89-.328-5.93-1.445-5.93-6.428 0-1.42.507-2.58 1.34-3.489-.134-.328-.581-1.65.128-3.44 0 0 1.092-.35 3.58 1.333a12.407 12.407 0 0 1 3.258-.438c1.106.004 2.22.148 3.258.438 2.485-1.683 3.575-1.333 3.575-1.333.71 1.79.265 3.112.13 3.44.835.909 1.337 2.069 1.337 3.489 0 4.995-3.047 6.095-5.946 6.416.467.403.886 1.198.886 2.415v3.578c0 .347.235.75.897.623C22.282 23.611 26 18.738 26 13c0-7.185-5.815-13-13-13z',
